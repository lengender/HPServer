/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: 2016年09月22日 星期四 10时40分04秒
 ************************************************************************/
...
#define FD_LIMIT 65535   //文件描述符数量的大小
...
int main(int argc, char *argv[])
{
    ...
    /*创建users数组，分配FD_LIMIT个client_data对象，可以预期：每个可能的socket连接都
     * 可以获得一个这样的对象，并且socket的值可以直接用来索引(作为数组的下标)socket连接
    ...
    */
    ...
    while(1)
    {
        ...
        for(int i = 0; i < user_counter + 1; ++i)
        {
            ...
            {
                //如果客户端关闭连接，则服务器也关闭对应的连接，并将用户总数减１
