/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: 2016年09月21日 星期三 21时43分41秒
 ************************************************************************/
...
void *worker(void *arg)
{
    ...
    while(1)
    {
        ...
        {
            close(sockfd);
            printf("foreiner closed the connecton\n");
            break;
        }
        else if(ret < 0)
        {
...
int main(int argc, char *argv[])
{
    ...
    //注意，监听socket listenfd上是不能注册EPOLLONESHOT事件的，否则应用
    //程序只能处理一个客户连接，因为后续的客户连接请求将不在触发listenfd上
    //的EPOLLIN事件
